...
<template>
  <div>
    <div class="relative group">
      ...
      />
      <div
        class="absolute z-40 inset-0 bg-black/50 rounded-[8px] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
