...
<template>
  <div class="relative group cursor-grabbing
         w-full
         sm:max-w-[240px] sm:aspect-[240/140]
         md:max-w-[470px] md:h-[230px]">
    <button
      class="cursor-pointer absolute z-50 top-4 right-4 w-8 h-8 rounded-full bg-grey-500 flex items-center justify-center">
    ...
    <div
      class="absolute h-full z-40 inset-0 bg-black/50 rounded-[8px] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      <button class="text-white p-2.5 bg-white/50 rounded-full cursor-pointer flex items-center ">
